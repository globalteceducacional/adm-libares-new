...
**Status:** Resposta alinhada — Opção A em andamento (**Tasks 1–3 concluídas**; auth leitor pronta; falta `api.php` catálogo)
...
|------|------------------------|
| Spec / plano | Prontos |
| `modules/reader/` | Tasks 1–3 ✅ — login/register/perfil/forgot; **falta** `api.php` catálogo |
