...
export function CategoriesPage() {
  ...
  const saveMutation = useAdminMutation<CategoryResponse, SaveCategoryVariables>({
    ...
    toastError: false,
    invalidate: invalidateCategoryQueries,
    onSuccess: () => {
      closeFormModal();
    },
    onError: (error) => {
  ...
  const activateMutation = useAdminMutation<CategoryResponse, CategoryResponse>({
    mutationFn: (category) =>
    ...
    successMessage: "Categoria ativada com sucesso.",
  ...
  function handleActivate(category: CategoryResponse) {
