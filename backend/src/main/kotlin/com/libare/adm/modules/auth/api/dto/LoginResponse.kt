...
@Schema(description = "Resposta de login com JWT e contexto de contratos")
data class LoginResponse(
    ...
    @field:Schema(description = "Contrato primario do usuario, se houver", nullable = true)
    val schoolId: Long?,

    @field:Schema(description = "Codigos de permissao efetivos")
    val permissions: List<String>,

    @field:Schema(description = "Contratos que o usuario pode acessar")
