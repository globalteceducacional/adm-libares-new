...
/** Variante galileu — mesmo contrato de register (envelope EBOOK_APP). */
@RestController
class UserRegisterGalileuController(
    private val register: ReaderRegisterUseCase
) {
    @RequestMapping(value = ["/user_register_galileu.php"], method = [RequestMethod.GET, RequestMethod.POST])
    fun register(
