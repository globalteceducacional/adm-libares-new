...
@Schema(description = "Dados para criar administrador (SCHOOL_ADMIN) de um contrato")
data class CreateSchoolAdminRequest(
    @field:Schema(description = "Nome de usuario (login)", example = "admin.contrato", requiredMode = Schema.RequiredMode.REQUIRED)
...
@Schema(description = "Administrador de contrato criado")
data class SchoolAdminResponse(
    @field:Schema(description = "ID do usuario administrativo", example = "10")
    val id: Long,

    @field:Schema(description = "Nome de usuario (login)", example = "admin.contrato")
    val username: String,
